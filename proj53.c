...
void evaluateScores(int *test1, int *test2, int *test3, double *average, double *avgTest2Test3);
...
int main() {
    ...
    evaluateScores(&score1, &score2, &score3, &avg, &avgTest2Test3);
    grade = letterGrade(avg, score3, avgTest2Test3);
    printResults(grade);
...
// This function calculates average and avgTest2Test3
void evaluateScores(int *test1, int *test2, int *test3, double *average, double *avgTest2Test3) 
{
